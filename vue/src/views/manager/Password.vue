      ...
      <div style="width: 50%; padding: 10px 0">
        <el-form :model="form" label-position="right" label-width="100px" style="padding-right: 40px">
          ...
          <el-form-item label="新密码">
            <el-input size="small" v-model="form.npw" placeholder="请输入新密码"></el-input>
          </el-form-item>
          <el-form-item label="确认密码">
            <el-input size="small" v-model="form.npw2" placeholder="请确认密码"></el-input>
          </el-form-item>
          <!-- 点击保存后调用更新函数 -->
...
export default {
  ...
  methods: {
    ...
    update() {
      ...
      if (this.form.npw !== this.form.npw2) {
